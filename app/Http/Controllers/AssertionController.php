...
class AssertionController extends Controller
{
    ...
    {
        $assertions = Assertion::with(['page.website', 'page.latest_screenshot', 'type', 'results' => function ($query) {
    ...
    public function show(Assertion $assertion)
    {
        ...
        $assertion->load(['page.website', 'page.latest_screenshot', 'type', 'latest_result', 'results' => function ($query) {
            $query->orderBy('created_at', 'desc')->whereDate('created_at', '>', Carbon::now()->subDays(30));
        }]);
