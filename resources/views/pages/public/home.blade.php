...
@section('content')
    <div class="mx-auto px-4">
        <div class="">
            <div class="lg:flex items-center m-6">
                <div class="lg:flex-1 px-6 text-left md:text-center xl:text-left inline-block align-text-bottom">
                ...
                <div class="lg:flex-1 mt-12 xl:mt-0 px-6">
                    <img class="" src="{{ asset('/img/wattch_guy/undraw_server_down_s4lk.svg') }}" alt="">
                </div>
            </div>
        ...
        <div class="flex flex-col break-words bg-white border border-1 rounded-lg shadow-md m-10 z-0"></div>

        <div class="lg:flex">
            @foreach($items as $key => $item)
                <div class="card bg-white overflow-hidden my-4 lg:m-4">
