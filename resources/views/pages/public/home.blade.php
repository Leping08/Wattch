...
@section('content')
    <div class="flex items-center">
        <div class="md:w-1/1 flex-1 md:mx-auto p-6">
            ...
            <div class="flex flex-col break-words bg-white border border-1 rounded shadow-md m-10 z-0">
            ...
            <div class="md:w-1/1 flex md:mx-auto relative">
                ...
                @foreach($items as $key => $item)
                    ...
                    <div
                        class="flex-1 max-w-sm rounded rounded-lg bg-white overflow-hidden shadow-lg m-4 hover:shadow-xl z-20">
                        ...
                        <div class="px-6 py-4">
                            @foreach($item['hashtags'] as $hashtag)
                                <span
                                    class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-800 mr-2 shadow">#{{$hashtag}}</span>
                            @endforeach
                        </div>
                    </div>
                @endforeach
