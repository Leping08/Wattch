...
<div class="flex">
    @foreach($navitems as $item)
        <a href="{{ $item['url'] }}" class="text-white text-justify no-underline italic text-gray-600 font-bold hover:text-gray-800 flex-grow-0 bg-gray-100 rounded-t-lg {{ $item['selected'] ? 'text-gray-800 border-t-2 border-r-2 border-l-2 border-teal-500' : '' }}">
            <div class="leading-tight py-2 text-sm px-8 hover:bg-gray-100 rounded-t-lg {{ $item['selected'] ? '' : 'border-b-2 border-teal-500 bg-gray-300' }}">
