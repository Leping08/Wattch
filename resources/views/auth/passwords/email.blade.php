    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                ...
                @if (session('status'))
                    <div class="text-sm border border-t-8 rounded text-teal-700 border-teal-600 bg-white p-4 my-4" role="alert">
                        {{ session('status') }}
                    </div>
                @endif

                <div class="flex flex-col break-words bg-gray-100 card mt-6">


                    <div class="bg-teal-600 px-4 py-2 rounded-t-lg shadow">
                        <span class="font-bold text-gray-200 no-underline">{{ __('Reset Password') }}</span>
                    </div>
