      ...
      _c("transition", { attrs: { name: "pop-out-quick" } }, [
        _c(
          "div",
          {
            ...
            staticClass:
              "bg-white absolute bg-card py-2 rounded-lg shadow mt-2",
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "overlay text-left absolute inset-0 flex justify-center opacity-0 items-center",
      attrs: { id: _vm.name }
    },
    [
      ...
      _c(
        "div",
        {
          staticClass: "modal relative rounded-lg bg-white p-4 shadow max-w-5xl"
        },
        [
          _vm._t("default"),
          _vm._v(" "),
